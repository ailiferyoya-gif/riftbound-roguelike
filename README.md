...
## v0.6.0 AAA Vertical Slice

- 戦闘後の航路分岐で、戦場・精鋭・予兆・休息・宝物庫から次の部屋を選択
- 通常攻撃と固有スキルを連続して使うと「RIFT RESONANCE」コンボが蓄積し、3コンボ目から追加ダメージ
- コンボランク、ベスト記録、次の航路をWebとiOSの戦闘画面に表示
- 分岐選択は各サイクルのルートに保存され、同じ深度でも異なる攻略ルートを作れる
